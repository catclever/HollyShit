# =========================================================================
# [ARCHIVED] LEGACY SCRIPT: Phase 1.1 (Point-based with Anisotropic Prior)
#
# [Reason for Archival]:
# This was an experimental branch of the "Point-based Flow Matching" architecture. 
# It attempted to shape the initial Gaussian noise into an Anisotropic Prior 
# (using `prior_mean` and `prior_std` from the true Z manifold) to shorten the ODE trajectory.
# However, because it still predicted a SINGLE pooled Z vector (destroying sequence 
# length and spatial token ordering), it was abandoned in favor of the new 
# "Conditional Sequence Flow Matching" architecture.
# =========================================================================
...
from training.archive.losses.flow_loss_v2_cuda import compute_flow_matching_loss_v2
